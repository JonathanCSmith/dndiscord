...
def create_default_data_pack(path):
    path = os.path.join(path, "default_data_pack")
...
def add_initial_tavern_states(data_pack):
    ...
    trollskull_manor_outset.append_state_modifier(FixedAttribute("trollskull_manor_land", 0))
    trollskull_manor_outset.append_state_modifier(FixedAttribute("trollskull_manor_land.private_street", 0))
    trollskull_manor_outset.append_state_modifier(FixedAttribute("trollskull_manor_land.outdoor_lighting", 0))
    trollskull_manor_outset.append_state_modifier(FixedAttribute("trollskull_manor_land.outdoor_signage", 0))
    data_pack.add_initial(trollskull_manor_outset)

    main_building = BusinessStateModifier("trollskull_manor_building")
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.appearance", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.condition", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.roof.condition", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.attic.condition", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.furnishings.condition", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.windows.condition", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.basement.condition", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.utilities.state", "off"))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.roof_slot", 0))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.communal_spaces.count", 7))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.rooms.count", 30))
    main_building.append_state_modifier(FixedAttribute("trollskull_manor_building.bathrooms.count", 7))
    ...
    kitchen_and_utilities_building.append_state_modifier(FixedAttribute("kitchen_and_utilities_building.condition", 0))
    kitchen_and_utilities_building.append_state_modifier(FixedAttribute("kitchen_and_utilities_building.utilities.state", "off"))
    ...
    stable_and_warehouse_building.append_state_modifier(FixedAttribute("stable_and_warehouse_building.condition", 0))
    stable_and_warehouse_building.append_state_modifier(FixedAttribute("stable_and_warehouse_building.utilities.state", "off"))
    data_pack.add_initial(stable_and_warehouse_building)

    # Add the garden
    garden = BusinessStateModifier("garden_plots")
    garden.append_state_modifier(FixedAttribute("garden_plots.condition", 0))
...
def add_basic_rebuild_purchases(data_pack):
    ...
    manor_repair.append_state_modifier(FixedAttribute("trollskull_manor_building.condition", 1))
    manor_repair.append_state_modifier(FixedAttribute("trollskull_manor_building.windows.condition", 1))
    manor_repair.append_state_modifier(FixedAttribute("trollskull_manor_building.basement.condition", 1))
    manor_repair.append_state_modifier(FixedAttribute("trollskull_manor_building.appearance", 1))
    ...
    roof_repair.append_state_modifier(FixedAttribute("trollskull_manor_building.roof.condition", 4))
    roof_repair.append_state_modifier(FixedAttribute("trollskull_manor_building.attic", 1))
    ...
    plumbing_repair.append_state_modifier(FixedAttribute("trollskull_manor_building.utilities.state", "on"))
...
def add_employees(data_pack):
    ...
    barstaff.append_state_modifier(ModifiesAttribute("basic_drinks_served", 80, "add"))
    barstaff.append_state_modifier(FixedAttribute("barstaff", ""))
...
def add_basic_drinks_prerequisites(data_pack):
    ...
    basic_taproom.append_state_modifier(FixedAttribute("basic_drinks_sold", 200))
    basic_taproom.append_state_modifier(FixedAttribute("trollskull_manor_building.taproom", 1))
    basic_taproom.append_state_modifier(FixedAttribute("taproom", 1))
    # TODO: Furninshing
    basic_taproom.append_state_modifier(ModifiesAttribute("common_patron_popularity_modifier", 10, "add"))
    basic_taproom.append_state_modifier(ModifiesAttribute("rough_patron_popularity_modifier", 2, "add"))
    basic_taproom.append_state_modifier(ModifiesAttribute("all_customers_maximum_occupancy_modifier", 50, "add"))
    ...
    basic_cellar.append_state_modifier(FixedAttribute("trollskull_manor_building.basement.cellar", 1))
    basic_cellar.append_state_modifier(ModifiesAttribute("basic_drinks_stored", 500, "add"))
    ...
    taproom_license_long.append_state_modifier(FixedAttribute("taproom_guild_license", "YES"))
    ...
    taproom_license_medium.append_state_modifier(FixedAttribute("taproom_guild_license", "YES"))
    ...
    taproom_license_short.append_state_modifier(FixedAttribute("taproom_guild_license", "YES"))
    ...
    street_services_long.append_state_modifier(FixedAttribute("street_services", "YES"))
    ...
    street_services_medium.append_state_modifier(FixedAttribute("street_services", "YES"))
    ...
    street_services_short.append_state_modifier(FixedAttribute("street_services", "YES"))
    ...
    water_services_long.append_state_modifier(FixedAttribute("water_services", "YES"))
    ...
    water_services_medium.append_state_modifier(FixedAttribute("water_services", "YES"))
    ...
    water_services_short.append_state_modifier(FixedAttribute("water_services", "YES"))
    ...
    refuse_services_year.append_state_modifier(FixedAttribute("refuse_services", "YES"))
    ...
    refuse_services_month.append_state_modifier(FixedAttribute("refuse_services", "YES"))
    ...
    refuse_services_short.append_state_modifier(FixedAttribute("refuse_services", "YES"))
    ...
    supply_basic_drinks_contract.append_state_modifier(FixedAttribute("basic_drinks_supplied", ""))
